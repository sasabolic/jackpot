...
INSERT INTO jackpot (id, version, current_cycle, initial_amount, currency, current_amount,
                     contribution_config_json, reward_config_json)
VALUES ('11111111-1111-1111-1111-111111111111', 0, 1,
        100.00, 'EUR', 100.00,
...
INSERT INTO jackpot (id, version, current_cycle, initial_amount, currency, current_amount,
                     contribution_config_json, reward_config_json)
VALUES ('22222222-2222-2222-2222-222222222222', 0, 1,
        250.00, 'EUR', 250.00,
...
INSERT INTO jackpot (id, version, current_cycle, initial_amount, currency, current_amount,
                     contribution_config_json, reward_config_json)
VALUES ('44444444-4444-4444-4444-444444444444', 0, 1,
        1000.00, 'EUR', 10000.00,
        '{"type":"VARIABLE","schemaVersion":1,"config":{"startingRate":"6.00","minimumRate":"1.00","decayFactor":"0.10"}}',
        '{"type":"VARIABLE_CHANCE","schemaVersion":1,"config":{"minPercent":"0.05","maxPercent":"100.00","minPool":{"amount":"5000.00","currency":"EUR"},"maxPool":{"amount":"120000.00","currency":"EUR"}}}');